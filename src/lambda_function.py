...
urlretrieve(" https://s3.amazonaws.com/mmcommons-tutorial/models/RN101-5k500-0012.params", f_params_file.name)
f_params_file.flush()

#symbol
f_symbol_file = tempfile.NamedTemporaryFile(delete=True)
urlretrieve("https://s3.amazonaws.com/mmcommons-tutorial/models/RN101-5k500-symbol.json", f_symbol_file.name)
f_symbol_file.flush()
